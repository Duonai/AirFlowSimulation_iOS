...
//mark
/*
 renderEncoder.setVertexBytes(&boundary_points[1].x, length: MemoryLayout<Float>.stride, index: 10)
 renderEncoder.setVertexBytes(&boundary_points[3].x, length: MemoryLayout<Float>.stride, index: 11)
 renderEncoder.setVertexBytes(&max_y, length: MemoryLayout<Float>.stride, index: 12)
 renderEncoder.setVertexBytes(&min_y, length: MemoryLayout<Float>.stride, index: 13)
 renderEncoder.setVertexBytes(&boundary_points[0].z, length: MemoryLayout<Float>.stride, index: 14)
 renderEncoder.setVertexBytes(&boundary_points[2].z, length: MemoryLayout<Float>.stride, index: 15)
 */
